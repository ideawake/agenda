...
/**
 * Internal method (RUN)
 * @param {Function} cb called when job is saved to mongo
 * @returns {undefined}
 */
 ...
 * @returns {boolean} whether or not job is running at the moment
 */
...
/**
 * Remove the job from Mongo
 * @param {Function} cb called when job is removed from mongo
 * @returns {undefined}
 */
 ...
 * @param {Function} cb called when job is "touched" and saved in mongo
 * @returns {undefined}
 */
